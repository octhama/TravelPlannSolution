...
-- Suppression des tables dans l'ordre inverse des dépendances (enfants d'abord, parents ensuite)
DROP TABLE IF EXISTS dbo.ActiviteVoyage;
DROP TABLE IF EXISTS dbo.HebergementVoyage;
DROP TABLE IF EXISTS dbo.OrganisationVoyage;
DROP TABLE IF EXISTS dbo.MembreGroupe;
DROP TABLE IF EXISTS dbo.PointsRecompense;
DROP TABLE IF EXISTS dbo.ReservationHebergement;
DROP TABLE IF EXISTS dbo.ClassementVoyageur;
DROP TABLE IF EXISTS dbo.NiveauRecompense;
DROP TABLE IF EXISTS dbo.Voyage;
DROP TABLE IF EXISTS dbo.GroupeVoyage;
DROP TABLE IF EXISTS dbo.Hebergement;
DROP TABLE IF EXISTS dbo.Activite;
